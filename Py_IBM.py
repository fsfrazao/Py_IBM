"""Py-IBM
    ...
    This module defines base classes for agent and individual based models.

    class World: provide methods to control the simulations and schedules; deal with model inputs and outputs; collect data from the agents and topology and control time.
    class Rectangular_Grid: represents a rectangular topology, inwhich patches are represented as square cells and can contain multiple layers of information (dimensions)
    class Agent: base class to represent agents
